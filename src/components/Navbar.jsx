...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white/80 backdrop-blur-lg border-b border-yellow-500 shadow-md sticky top-0 z-50 font-mono">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="text-2xl font-bold text-green tracking-wider glow-text">
            🐔Agrify
          </Link>
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white border border-yellow-500 rounded-lg shadow-lg z-50">
                    ...
                    <Link to="/settings" className="block px-4 py-2 text-sm text-black hover:bg-yellow-900">⚙️Settings</Link>
